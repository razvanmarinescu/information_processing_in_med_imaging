...
%       hdr.hist.srow_z(4) = (1-hdr.hist.originator(3))*hdr.dime.pixdim(4);
      ...
      hdr.hist.srow_z(2) = 0;
      hdr.hist.srow_z(3) = hdr.dime.pixdim(4);
      hdr.hist.srow_x(4) = hdr.hist.originator(1);
      hdr.hist.srow_y(4) = hdr.hist.originator(2);
      hdr.hist.srow_z(4) = hdr.hist.originator(3);
   end
...
function data_history(fid, hist)
   ...
   % fwrite(fid, aux_file(1:24),   'uchar');file:///usr/share/doc/HTML/en-US/index.html
